...
void ADynamicTextureActor::BeginPlay()
{
    ...
    DynamicTexture = UTexture2D::CreateTransient(TextureWidth, TextureHeight, PF_B8G8R8A8);
    if (DynamicTexture)
    {
...
//void ADynamicTextureActor::UpdateTexture()
//{
//    UE_LOG(LogTemp, Warning, TEXT("UpdateTexture running..."));
//    if (!DynamicTexture)
//        return;
//
//    void* MipData = nullptr;
//    int32 MipIndex = 0; // Use the base mip level
//    DynamicTexture->GetMipData(MipIndex, &MipData);
//
//    if (MipData)
//    {
//        FColor* FormattedImageData = static_cast<FColor*>(MipData);
//        int32 TextureWidth = DynamicTexture->GetSizeX();
//        int32 TextureHeight = DynamicTexture->GetSizeY();
//        
//        UE_LOG(LogTemp, Warning, TEXT("Width %d"), TextureWidth);
//
//        // Fill the texture with a random color
////        FColor RandomColor = FColor::MakeRandomColor();
//        FColor RandomColor = FColor(255, 255, 255, 255);
//        for (int32 y = 0; y < TextureHeight; y++)
//        {
//            for (int32 x = 0; x < TextureWidth; x++)
//            {
//                int32 Index = y + x * TextureWidth;
//                FormattedImageData[Index] = RandomColor;
//            }
//        }
//
//        // Ensure the texture updates on the GPU
//        DynamicTexture->UpdateResource();
//    }
//}
